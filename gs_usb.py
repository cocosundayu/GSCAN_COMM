...
class GsUsb:
    ...
    def start(self, flags=(GS_CAN_MODE_NORMAL | GS_CAN_MODE_HW_TIMESTAMP) ):
        ...
        self.gs_usb.ctrl_transfer(0x41, _GS_USB_BREQ_MODE, gl.global_var, 0, mode.pack())
    ...
    def set_bitrate(self,channel, bitrate, sample_point=87.5):
        r"""
    ...
    def set_timing(self, prop_seg, phase_seg1, phase_seg2, sjw, brp):
        ...
        self.gs_usb.ctrl_transfer(0x41, _GS_USB_BREQ_BITTIMING, gl.global_var, 0, bit_timing.pack())
    ...
    def device_info(self):
        ...
        """
        data = self.gs_usb.ctrl_transfer(0xC1, _GS_USB_BREQ_DEVICE_CONFIG, gl.global_var, 0, 12)
    ...
    def device_capability(self):
        ...
        if self.capability == None:
            data = self.gs_usb.ctrl_transfer(0xC1, _GS_USB_BREQ_BT_CONST, gl.global_var, 0, 40)
