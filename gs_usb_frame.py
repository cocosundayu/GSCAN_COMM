...
class GsUsbFrame:
    def __init__(self, can_id=0, channel=0, data=[]):
        self.echo_id = channel
        self.can_id = can_id
    ...
    def __str__(self) -> str:
        ...
        return "channal{} canid 0x{:X}  DLC{}  DATA{}".format(self.channel, self.arbitration_id, self.can_dlc, data)
